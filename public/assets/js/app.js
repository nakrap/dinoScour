...
$.getJSON("/articles", function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      $("#articles").append("<p class= list-group-item list-group-item-action active data-id='" + data[i]._id + "'>" + data[i].title + "<br />" + "<a target=_blank href='" + data[i].link + "'>" + data[i].link + "</a>" + "</p>");
    }
